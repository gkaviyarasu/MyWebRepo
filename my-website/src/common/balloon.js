 ...
 * @param	{HTMLElement}	canvasElement		Unique ID of the canvas element displaying the balloon
 ...
 */
CANVASBALLOON.Balloon = function(canvasElement, centerX, centerY, radius, color) {
...
CANVASBALLOON.Balloon.prototype.draw = function() {
    ...
    balloonGradient.addColorStop(0, this.lightColor.hsl().string());
    balloonGradient.addColorStop(.7, this.darkColor.hsl().string());
